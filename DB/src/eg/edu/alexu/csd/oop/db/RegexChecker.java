...
public class RegexChecker {
	 ...
	 static String col [] = new String [100000 + 10];
	
	 public static String regexChecker1(String theRegex, String str2Check) throws SQLException{
	 ...
	 public static String [] regexChecker2(String theRegex, String str2Check) throws SQLException{
